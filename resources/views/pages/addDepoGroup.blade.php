            ...
            <div class="card-body p-4">
                <div class="table-responsive">
                    <form name="depoInfo" id="depoInfo" method="POST"
                        action="{{isset($depoGroups->uid)? route('request.updateDepoGroups',$depoGroups->uid):route('request.addDepoGroups')}}">
                        <fieldset>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input name="depo_rep_contact" type="text" minlength='11'
                                                ...
                                                value="{{isset($depoGroups) ? $hrGroups->hr_contact : ''}}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <livewire:modal-form-component wire:id="{{rand()}}" wire:key="{{rand()}}"
                                            ...
                                            :oldData='$depoGroups->hr_category' />
                                        @else
                                        <livewire:modal-form-component wire:id="{{rand()}}" wire:key="{{rand()}}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="depo_category" id="depo_category" class="form-select">
                                                ...
                                                <option value="{{$category->display_name}}" {{isset($depoGroups->depo_category) ? ($depoGroups->depo_category ==
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input name="staff_quantity" type="number" class="form-control"
                                                ...
                                                value="{{isset($depoGroups) ? $hrGroups->staff_quantity : ''}}"
